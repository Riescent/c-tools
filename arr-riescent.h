...
void randomize_array_int(int *arr, const int arr_size, const int min, const int max)
{
...
void sort_array_int(int *ptr_arr, const int arr_size)
{
...
int binary_search_int(const int target, const int *arr, const int arr_size)
{
	int mid;
	int high = arr_size - 1;
	int low = 0;
